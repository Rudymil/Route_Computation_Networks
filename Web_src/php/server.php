...
if (isset($_GET["type"]) && ($_GET["type"] == "warning_zone" ||
                              $_GET["type"] == "anomaly_zone" ||
                              $_GET["type"] == "warning_type" ||
                              $_GET["type"] == "anomaly_type")) {
  ...
  }elseif ($_GET["type"] == "warning_type") {
    $zones_list = "SELECT id, name FROM risk ORDER BY name;";
  }elseif ($_GET["type"] == "anomaly_type") {
    $zones_list = "SELECT id, name FROM anomaly ORDER BY name;";
  }
